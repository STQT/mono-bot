...
TRANSLATIONS = {
    'uz_latin': {
        ...
        'WEBAPP_SUCCESS_MESSAGE': "Sizning sovg’angiz tayyorlanmoqda, yaqin orada bizning xodimlarimiz siz bilan bog’lanamiz.",
        ...
        'WEBAPP_QR_MAX_ATTEMPTS': "❌ Siz bugun {max_attempts} marta noto’g’ri QR-kod kiritdingiz. Keyingi urinishlar ertaga (00:00) qayta ochiladi.",
