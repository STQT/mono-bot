...
TRANSLATIONS = {
    'uz_latin': {
        ...
        'NAME_TOO_SHORT': "❌ Ism juda qisqa. Iltimos, kamida 2 ta belgi kiriting.",
        ...
        'GIFT_STATUS_APPROVED': "✅ Tabriklaymiz! Sizning '{gift_name}' sovg'angiz tasdiqlandi!\n\nSovg'angiz tayyorlanmoqda va yaqin orada sizga yetkaziladi.",
        'GIFT_STATUS_REJECTED': "❌ Afsuski, sizning '{gift_name}' sovg'angiz so'rovi rad etildi.\n\nSabab: {admin_notes}\n\nAgar savollaringiz bo'lsa, administrator bilan bog'laning.",
        'GIFT_STATUS_COMPLETED': "🎉 Tabriklaymiz! Sizning '{gift_name}' sovg'angiz yetkazildi va yakunlandi!",
        'GIFT_DELIVERY_SENT': "📦 Sizning '{gift_name}' sovg'angiz yuborildi!\n\nTez orada sizga yetkaziladi.",
        'GIFT_DELIVERY_DELIVERED': "✅ Sizning '{gift_name}' sovg'angiz yetkazildi!\n\nIltimos, qabul qilinganini tasdiqlang.",
    ...
    'ru': {
        ...
        'GIFT_STATUS_APPROVED': "✅ Поздравляем! Ваш запрос на подарок '{gift_name}' одобрен!\n\nВаш подарок готовится и скоро будет доставлен.",
        'GIFT_STATUS_REJECTED': "❌ К сожалению, ваш запрос на подарок '{gift_name}' отклонен.\n\n{admin_notes}\n\nЕсли у вас есть вопросы, свяжитесь с администратором.",
        'GIFT_STATUS_COMPLETED': "🎉 Поздравляем! Ваш подарок '{gift_name}' доставлен и завершен!",
        'GIFT_DELIVERY_SENT': "📦 Ваш подарок '{gift_name}' отправлен!\n\nСкоро он будет доставлен вам.",
        'GIFT_DELIVERY_DELIVERED': "✅ Ваш подарок '{gift_name}' доставлен!\n\nПожалуйста, подтвердите получение.",
